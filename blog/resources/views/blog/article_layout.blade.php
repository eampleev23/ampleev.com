                    ...
                    <article class="article"><p class="lead"> Я практически уверен, что все хотят создавать легко
                        ...
                        <article>
                            ...
                            <p class="lead">Каждый микросервис подключается к брокеру. Все сервисы могут получать и
                                отправлять сообщения через одно соединение. Микросервис, отправляющий сообщения,
                                называется
                            ...
                            <ul>
                                <li>
                                    ...
                                    коробки. Это делает общую архитектуру более простой и легко масштабируемой.
                                    Некоторые
                                ...
                                <li>
                                    Потоковое проектирование: Такой подход также порождает концепцию потоков. Каждая
                                    тема по
                                    сути является потоком сообщений. Любой подписчик может подключиться к этим потокам
                                    по
                            ...
                            <ul>
                                ...
                                <li>
                                    Более высокая задержка: количество прыжков в шине сообщений увеличивает общую
                                    задержку.
                                ...
                                <li>
                                    Более высокое расходование ресурсов. Для работы брокерам необходимы ресурсы CPU,
                                    памяти
                                    и хранилища. Эти ресурсы могли бы быть использованы для запуска других
                                    микросервисов.
                            ...
                            <p class="lead">
                                ...
                                переключение,
                                если
                                вам нужна гибкость потоков или вам нужно использовать семантику pub-sub шины сообщений.
                                Если
                                вы начинаете с нуля, имеет смысл начать с дизайна без брокера, а затем переключиться,
                                когда
                            ...
                            <p class="lead">
                                Использование правильного подхода к построению микросервисов важно. Выбор способа
                                общения
                                является
                                фундаментальным решением, которое необходимо принимать с большой осторожностью.
                            </p>

                            <p class="lead">Есть разные варианты реализаций для обоих подходов к архитектуре.
                                Придерживаться
                                устоявшейся основы почти
                                всегда имеет больше смысла, чем создавать что-то с нуля. Чаще всего есть вариант решения
                                без
                                смены парадигмы. Для
                            ...
                            <p class="lead">
                                ...
                                например.
                                Space Cloud автоматизирует весь бэкэнд, поэтому вы сможете сосредоточиться на
                                бизнес-логике,
