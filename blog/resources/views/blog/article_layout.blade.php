        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-10">
                    <article><br/> <br/>
                        <p class="lead"> Ниже приведены 5 лайфхаков, которые я использую в своей ежедневной работе
                            ...
                            инструментами для повышения общей эффективности вашей работы. Наслаждайтесь! </p><br/>
                        <h2>1. Статус ветки GIT в терминале</h2>
                        <p class="lead"> Во-первых, есть очень простое улучшение, которое на столько популярное, что
                            недавно оно было включено в iTerm2 (такой новый терминал для macOS с кучей приблуд всяких
                            полезных) в качестве основной фичи. </p>
                        <p class="lead"> При работе в GIT-репозитории полезно иметь перед глазами описание ветки, в
                            ...
                            умолчанию перед вводом команды там же, где и '$'). </p>
                        <p class="lead"> Возможно, способ с настройкой профиля Bash и сейчас проканает, но я расскажу о
                        ...
                        <ul>
                            ...
                            <br/>
                            <figure><img role="presentation" src="/assets/img/5haks_1.png"
                                         alt="Разблокируйте Status bar - изображение" class="rounded border shadow-lg">
                                <figcaption> Разблокируйте Status bar</figcaption>
                            </figure>
                            <li>Сконфигурируйте Status Bar, выбрав и перетащив компонент ветки с названием "master"</li>
                            <br/>
                            <figure><img role="presentation" src="/assets/img/5haks_2.png"
                                         alt="Разблокируйте Status bar - изображение" class="rounded border shadow-lg">
                                <figcaption> Выберите и перетащите компонент ветки с названием "master" в окно "Active
                                    components"
                                </figcaption>
                            </figure>
                        </ul>
                        <p class="lead"> Конечно, вам решать, где и когда использовать данную фичу. Лично я сейчас
                            использую ее во всех клиентах консоли, которые использую, т.к., не видя ветки, я уже начинаю
                            ощущать физический дискомфорт. </p>                          <br/>
                        <h2>2. Используйте Tmux</h2>
                        <p class="lead"> Если вы не знакомы с Tmux, то я рекомендую поставить его и потестить. На первый
                            взгляд он может показаться обычным диспетчером окон / сессий, но в действительности это
                            невероятно сложный (в хорошем смысле) функциональный инструмент. </p>
                        <p class="lead"> Tmax позволяет управлять несколькими окнами с помощью горячих клавиш. Одно из
                            самых удобных преимуществ - это возможность останавливать сессии и возвращаться к любой из
                            них позже. </p>
                        <p class="lead"> Это может быть особенно полезно если у вас удаленная машина. Вы можете начать
                            сеанс, запустить долго выполняющийся скрипт, затем поставить его на паузк и выпить
                            кофе. </p>
                        <p class="lead"> Пока вы ходите за кофе, ваша сессия будет ждать вас ровно в том месте и
                            состоянии, в котором вы ее оставили. </p>
                        <p class="lead"> Еще одно удивительное преимущество заключается в том, что Tmux автоматически и
                            корректно приостановит ваш сеанс, если вы потеряете соединение ssh с вашей удаленной
                            машиной. </p>
                        <p class="lead"> Если вы подключаетесь к удаленному компьютеру, откройте новый сеанс Tmux, а
                            затем откройте ваш файл в Vim. В этом сеансе он будет защищен от адского файла *.swp, если
                            вы отключитесь. Это преимущество сложно переоценить. </p>
                        <p class="lead"> Tmux спас мою задницу больше раз, чем я могу сосчитать. Честно. </p><em>Продолжение
                            планируется во <a href="https://ampleev.com/article_5_prostih_hakov_okruzhenia_razrabotchika_dlia_povishenia_proizvoditelnosti_chast_2">второй части статьи</a>.</em></article>
