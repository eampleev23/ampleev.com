...
@section('title', "5 простых хаков окружения разработчика для повышения производительности")
@section('description', 'Простые, но эффективные способы улучшить вашу жизнь как разработчика.')
@section('page_url', route('blog.show_article', '5_prostih_hakov_okruzhenia_razrabotchika_dlia_povishenia_proizvoditelnosti'))
