...
<head>
    <meta charset="utf-8">
    <title>Блог | Амплеев Евгений - Scrum Master / Full stack web developer</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-5 col-lg-6 col-md-8">
                ...
                <p class="lead mb-0">Планирую писать здесь обо всем, что меня волнует. В основном, это будет, как мне
                    кажется, об Agile, но увидим.</p>
            </div>
        </div>
    </div>
    <div class="divider">
        ...
        <div class="row mb-4">
            <div class="col-md-8 col-lg-9">
                <div class="pr-lg-4">
                    ...
                    <img class="icon icon-sm bg-primary" src="assets/img/icons/interface/heart.svg"
                        ...
                        <div>
                            <h2>Полезное приложение, которое позволяет эффективно планировать собственное время и не только.</h2>
            ...
            <div class="col-md-4 col-lg-3 d-none d-md-block">
                <div class="mb-4">
                    ...
                    <small class="text-muted form-text">Мы никогда не раскроем ваши данные. Смотрите наши <a href="#">Условия
