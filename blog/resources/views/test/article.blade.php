...
const (
	...
	December  Month = 12
                    ...
                    <p class="lead">Как видите, идентификатор <code>iota</code> в <strong>Go</strong> можно использовать
                        ...
                        позаботиться о том,
                        чтобы будущие изменения не привели к повреждению данных. Если вы вынесете из этой статьи одну и
                        только одну вещь, то это то, что если вы экспортируете какие-либо константы, использующие <code>iota</code>,
                    ...
                    <ol>
                        <li>Константы, определяемые <code>iota</code>, экспортируются</li>
                        <li>Константы, определенные <code>iota</code>, будут когда-либо сериализованы и десериализованы
                            (например, сохранены в файл и считаны обратно).
                        </li>
                    </ol>

                    <h2>Полезные ссылки</h2>
                    <p class="lead">Если вам понравилось читать эту статью, возможно, вам будут интересны и эти
                        связанные с ней статьи:</p>
                    <ol>
                        <li>Описание системы типов в <strong>Go</strong></li>
                        <li>Использование системы типов в <strong>Go</strong></li>
                    </ol>
