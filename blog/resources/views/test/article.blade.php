        ...
        <div class="row justify-content-center position-relative">
            ...
            <div class="col-lg-10 col-xl-8">
                ...
                <p class="lead"><strong>Микросервисная архитектура</strong> - не новая технология на рынке. Без
                    ...
                    уже
                    слышали о
                    ней, а возможно, ваша компания даже уже перешла на нее. Столь массовый переход от монолитной
                    архитектуры
                    к микросервисам основан на очевидных и мощных преимуществах микросервисов:</p>
                <br/>
                <ul>
                    <li><strong>Гибкость (Agility)</strong>. Микросервисы позволяют создавать небольшие, эффективные,
                        ...
                        подходит
                        для внедрения Agile-практик управления проектами. Кроме того, она значительно сокращает время
                        выхода
                        на рынок.
                    </li>
                    <br/>
                    <li><strong>Инновации</strong>. Не секрет, что процедурные и технологические изменения быстрее и
                        легче
                        вносятся в
                        небольших масштабах. Команды могут опробовать новое и быстро понять, что работает, а что нет.
                        Такие
                        небольшие эксперименты не повлияют на всю организацию.
                    </li>
                    <br/>
