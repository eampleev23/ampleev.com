...
<section class="p-0" data-reading-position>
    <div class="container">
        <div class="row justify-content-center position-relative">
            <div class="col-lg-10 col-xl-8">
                <span class="text-small text-muted">Один вопрос, который всех волнует с момента выхода 7 серии 5 сезона: &#171;Когда выйдет
        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    <p class="lead">Одно из самых любимых зрителями телевизионных шоу канала Showtime &#171;Миллиарды&#187;
                        вынуждено было встать на паузу после выхода 7 серии &#171;Бесконечное дерьмо&#187; по всем
                        известной причине (да да, что-то там про корону и вирусы). </p>

                    <p class="lead">Сезон прирвался на моменте, где Акс (Bobby Axelrod (Damian Lewis))
                        метафорично дает задание своему исполнительному директору Ваксу (Wags (David Costabile))
                        стратегию дaльнейшей борьбы с Майком Фомой Аквинским Принсем (Mike
                        Prince (Corey Stoll)) &#8210; залечь на дно
                        и выяснить чем он больше всего дорожит чтобы его уничтожить).</p>

                    <p class="lead">В то время как Майк Принс ведет, кажется, войну только с Аксом, у Акса есть много
                        других проблем. Его вымораживают отношения между Венди и художником Нико Теннером. Чак Роудс
                        отчаянно ищет почку для отца и хочет не впутываться в грязные для своей репутации игры, но не
                        забывает обвинить во всех своих проблемах Акса и их союз трещит по швам. Тейлор
                        проявляет самостоятельную инициативу и тоже подливает масла в огонь. Естественно, поклонникам
                        сложно все это собрать воедино и они жаждут продолжения. </p>
                    ...
                    <p class="lead">После выхода в эфир последнего эпизода 15 июня 2020 года, шоураннер Брайан Копельман
                        написал в своем
                        твиттере </p>
