    ...
    <div class="container">
        <div class="row justify-content-center position-relative">
            ...
            <ol>
                ...
                <br/>
                <li><strong>Качество</strong>. Небольшие и хорошо структурированные модули обычно имеют меньше ошибок по
                    сравнению со
                    сложными монолитными системами, в которых обычно присутствует унаследованный «спагетти-код». Кроме
                    того, такая среда упрощает автоматизацию тестирования. В результате качество существенно повышается.
                </li>
                <br/>
                <li><strong>Масштабируемость</strong>. Основное преимущество заключается в том, что каждый конкретный
                    сервис может быть
                ...
                <li><strong>Доступность</strong>. Микросервисы упрощают создание высокодоступных систем. Хорошо
                    определенные,
                    изолированные компоненты можно развертывать, отслеживать и автоматически заменять в случае отказа.
