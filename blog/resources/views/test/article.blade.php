        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    ...
                    <p class="lead">В HTTP/1.1 киллер-фичей была конвейерная обработка, которая на бумаге выглядела как
                    ...
                    <p class="lead">
                        <br/>
                        <br/>
                        Зачем это было нужно: эта фича решала проблему, которая заключалась в том, что запросы
                        отправлялись по порядку, а ответы должны
                        были возвращаться в том же порядке. Если один ответ задерживался (например, если серверу
                        требовалось дополнительное время на его обработку) - все остальные в очереди вынуждены были
                        ждать.</p>
