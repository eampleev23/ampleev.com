...
Go Version: go 1.22.0
                    ...
                    <p class="lead">Мы можем пойти еще дальше и использовать <code>iota</code> для вычисления таких
                        вещей, как объем
                        памяти. Например, давайте рассмотрим следующий набор констант:</p>
                    <pre class="language-go"><code>
const (
