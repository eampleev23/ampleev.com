            ...
            <div class="col-lg-10 col-xl-8">
                ...
                <ul>
                    ...
                    <li><strong>Инновации</strong>. Не секрет, что процедурные и технологические изменения быстрее и
                        ...
                        или нет.
                        Такие
                        небольшие эксперименты в рамках контроллируемых командой микросервисов, сильно снижают риск
                        возникновения блокеров (от англ. <strong>Blocker</strong> - ошибка, которая блокирует
                        работу критически важных бизнес-процессов) в проде.
                    </li>
                    <br/>
                    <li><strong>Качество</strong>. Небольшие и хорошо структурированные модули обычно имеют меньше
                        ошибок по
                        сравнению со
                        сложными монолитными системами, в которых обычно присутствует унаследованный «спагетти-код».
                        Кроме
                        того, такая среда упрощает автоматизацию тестирования. В результате качество существенно
                        повышается.
                    </li>
                    <br/>
