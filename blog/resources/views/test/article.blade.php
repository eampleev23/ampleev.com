                ...
                <div class="col py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex">
                            ...
                            <div class="text-small">Система типов в <strong>Golang</strong>
                            </div>
                            <!-- Заголовок в прогресс-баре -------------------------------------------------------->
                        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-8">
                ...
                <!-- Заголовок статьи H1-->
                <h1>Система типов в <strong>Golang</strong></h1>
                <!-- Заголовок статьи H1-->
                <!-- ----------------------------------------------------------------------------------------------------------->
                <div class="d-flex align-items-center">
                    <a href="#">
    ...
    <div class="container">
        <div class="row justify-content-center position-relative">
            <div class="col-lg-10 col-xl-8">
                ...
                <!-- First paragraph-->
                <!-- ----------------------------------------------------------------------------------------------------------->
                <figure><img src="/assets/img/programming-background-collage.jpg"
                             alt="Система типов в Golang"
            ...
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    ...
                    <figure class="sign">
                        ...
                        <figcaption>Схема 5 команд, работающих над <code>it</code>-продуктом с микросервисной
                            архитектурой
                        </figcaption>
                    </figure>
