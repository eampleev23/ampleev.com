        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    ...
                    <p class="lead">В наборе инструментов <strong>HTTP/2</strong> есть и несколько других удобных
                        средств. На протяжении
                        всего соединения любая сторона может отправлять Фрэймы <code>WINDOW_UPDATE</code> для управления
                        потоком,
                        Фрэймы <code>PING</code> для проверки, живо ли еще соединение, и Фрэймы <code>PRIORITY</code>
                        для
                        точной настройки
                        приоритетов потоков. А если что-то пойдет не так, Фрэймы RST_STREAM могут отключить отдельные
