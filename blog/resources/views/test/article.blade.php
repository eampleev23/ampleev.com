    ...
    <div class="container">
        <div class="row justify-content-center position-relative">
            <div class="col-lg-10 col-xl-8">
                ...
                <br/>
                <ul>
                    <li><strong><h3>Гибкость (Agility)</h3></strong>
                    ...
                    <li><strong><h3>Масштабируемость</h3></strong> Основное преимущество заключается в том, что каждый
                        ...
                        бизнес-логика на
                        Java, критически важные модули на Erlang. По своей сути микросервисная архитектура it-продукта
                        допускает
                        горизонтальное масштабирование, что позволяет масштабировать систему, в полной мере использовать
                        преимущества <strong>Docker</strong> и <strong>облачных ресурсов</strong>.
                    </li>
                    <br/>
