    ...
    <div class="container">
        <div class="row justify-content-center position-relative">
            ...
            <div class="col-lg-10 col-xl-8">
                ...
                <p class="lead"><strong>Микросервисная архитектура</strong> - не новая технология на рынке. Без сомнения, вы
                    уже
                    слышали о
                ...
                </figure>             <p class="lead"><code>iota</code> - полезная концепция для создания инкрементных
                    констант в <strong>Go</strong>. Однако есть несколько областей, в которых использование этой
                    функциональности языка может быть неуместным. В этой статье мы рассмотрим несколько различных
                    способов применения <code>iota</code>, а также дадим рекомендации о корректности ее использования.
                </p>
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    <br/>
                    <h2>Проблемы, связанные с <strong>релизами</strong> продуктов на микросервисной архитектуре</h2>
                    <p class="lead">Конечно, <strong>rмикросервисная архитектура</strong> - это не серебряная пуля. Как
                        и все в этом мире,
