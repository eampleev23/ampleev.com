    ...
    <div class="container">
        <div class="row justify-content-center position-relative">
            <div class="col-lg-10 col-xl-8">
                ...
                <pre class="language-go"><code>BenchmarkFunc-8  67836464  16.0 ns/op  8 B/op  1 allocs/op</code></pre>
                <!-- ----------------------------------------------------------------------------------------------------------->
                <!-- End first paragraph-->
                <!-- ----------------------------------------------------------------------------------------------------------->
            </div>
            ...
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article"><br/>
                    ...
                    <p class="lead">Для того чтобы разобраться в значении параметра <code>allocs/op</code> в
                        ...
                        областях памяти, которые используются в <strong>Go</strong>-программах: <strong>Стэк (от англ.
                            Stack)</strong> и
