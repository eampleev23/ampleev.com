            ...
            <div class="col-xl-7 col-lg-8 col-md-10">
                <article class="article"><p class="lead"> В этой статье я планирую рассказать как на своей практике мы
                    ...
                    <p>Эти 3 наблюдения в совокупности приводят к следующему выводу. Здесь явно еще на ранних этапах
                        (где-то во второй-третий день спринта) нужно было Скрам Мастеру обратить внимание на полоску
                        "Тестирование", которая слишком мала и не меняется достаточно долго. Можно предположить, что
                        объем работы готовой для тестирования невозможно протестировать по каким-либо обстоятельствам,
                        но тогда это означает, что тестировщики простаивают, а значит, на пятый день спринта, когда
                        появляется объем работы готовой для тестирования, она сразу же должна пойти в работу, но и этого
                        не происходит (мы убеждаемся в этом на 6-й день спринта согласно диаграмме)
                        "Готово для тестирования"</p>
