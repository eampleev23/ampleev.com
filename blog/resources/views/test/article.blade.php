        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    ...
                    <br/>
                    <br/>
                    <p>После того как вы освоились с net/rpc из предыдущей статьи (<a href="https://victoriametrics.com/blog/go-net-rpc/index.html">From net/rpc to gRPC in Go Applications</a>),
                        вероятно, будет хорошей идеей начать изучать HTTP/2, который является основой протокола gRPC.</p>
                </article>
                <!-- ----------------------------------------------------------------------------------------------------------->
                <!-- Основной контент -->
                <!-- ----------------------------------------------------------------------------------------------------------->
