    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-8">
                ...
                <!-- Заголовок статьи H1-->
                <h1>Эффективное управление релизами <code>it</code>-продуктов на базе микросервисной архитектуры</h1>
                <!-- Заголовок статьи H1-->
                <!-- ----------------------------------------------------------------------------------------------------------->
                <div class="d-flex align-items-center">
                    <a href="#">
            ...
            <div class="col-lg-10 col-xl-8">
                ...
                <ul>
                    <li><strong><h3>Гибкость <code>(Agility)</code></h3></strong>
                        <strong>Микросервисы позволяют создавать
                            небольшие, эффективные,
                            сфокусированные и наделенные
                            полномочиями команды, способные выбирать свой технологический стек и процесс</strong>. Таким
                        командам не
                        ...
                        <strong><code>it</code>-продуктами</strong>. Кроме
                        того, она
                    ...
                    <li><strong><h3>Инновации</h3></strong>
                        Не секрет, что <strong>процедурные и технологические изменения быстрее и
                            легче
                            вносятся в
                            небольших масштабах</strong>. Команды могут быстро проверить какую-либо гипотезу и понять,
                        работает она
                        или нет.
                        Такие
                    ...
                    <li><strong><h3>Качество</h3></strong> Небольшие и хорошо структурированные
                        <strong>микросервисы
                            ...
                            ошибок</strong> по
                        сравнению со
                        сложными монолитными системами, в которых обычно присутствует унаследованный
                        <strong><a
                        ...
                        Кроме
                        того, такая архитектура <strong>упрощает автоматизацию тестирования</strong>. В результате
                        <strong>качество
                            существенно
                            повышается</strong>.
                    </li>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    <br/>
                    <h2>Проблемы, связанные с <strong>релизами</strong> <code>it</code>-продуктов на микросервисной
                        архитектуре</h2>
                    <p class="lead">Конечно, <strong>микросервисная архитектура</strong> - это не серебряная пуля. Как
                        ...
                        сосредоточусь только на проблемах, связанных с <strong>управлением релизами
                            <code>it</code>-продуктов на микросервисной архитектуре</strong>. С этой точки зрения
                    ...
                    <figure class="sign">
                        ...
                        <figcaption>Схема 5 команд, работающих над <code>it</code>-продуктом с микросервисной архитектурой
                        </figcaption>
                    </figure>
