        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article"><br/>
                    ...
                    <p class="lead">Во многих популярных средах программирования под <strong>Стеком</strong> обычно
                        подразумевается Стек
                        вызовов <strong>Потока (от англ. Thread)</strong>. <strong>Стек вызовов</strong> - это Стековая
                        структура данных
                        ...
                        Каждый вызов функции добавляет (pushes) новый фрэйм в <strong>Стек</strong>, а каждый возврат
                        функции удаляет
                        (pops) из <strong>Стека</strong>.</p>
