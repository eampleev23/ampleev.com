                ...
                <article class="article">
                    ...
                    <ul>
                        <li><strong>Частые релизы</strong>. По своей природе архитектура микросервисов вынуждает нас
                            ...
                            нескольких
                            микросервисов. С точки зрения управления <strong>релизами</strong> это создает накладные
                            расходы на
                        ...
                        <li><strong>Вариативный процесс разработки</strong>. <strong>Scrum</strong>,
                            ...
                            разработчиков, но может стать кошмаром для <strong>менеджера проекта</strong> или <strong>менеджера
                                релиза</strong> (
                            <strong>PM</strong>
