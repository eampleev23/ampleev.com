...
<head>
    ...
    <!-- Title ----------------------------------------------------------->
    <title>Эффективное управление релизами it-продуктов на базе микросервисной архитектуры</title>
    <!-- Title ----------------------------------------------------------->
                ...
                <div class="col py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex">
                            ...
                            <div class="text-small">Эффективное управление релизами <strong>ПО</strong> на базе <strong>микросервисной
                                    архитектуры</strong>
                            </div>
                            <!-- Заголовок в прогресс-баре -------------------------------------------------------->
                        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-8">
                ...
                <!-- Заголовок статьи H1-->
                <h1>Эффективное управление релизами it-продуктов на базе микросервисной архитектуры</h1>
                <!-- Заголовок статьи H1-->
                <!-- ----------------------------------------------------------------------------------------------------------->
                <div class="d-flex align-items-center">
                    <a href="#">
    ...
    <div class="container">
        <div class="row justify-content-center position-relative">
            <div class="col-lg-10 col-xl-8">
                ...
                <!-- First paragraph-->
                <!-- ----------------------------------------------------------------------------------------------------------->
                <figure><img src="/assets/img/release_main.png"
                             alt="Эффективное управление релизами it-продуктов на базе микросервисной архитектуры"
                ...
                <p class="lead"><strong>Микросервисная архитектура</strong> - не новая технология на рынке. Без
                    ...
                    уже
                    слышали о
                    ней, а возможно, ваша компания даже уже перешла на нее. Столь массовый переход от <strong>монолитной
                        архитектуры</strong>
                    к <strong>микросервисам</strong> основан на очевидных и мощных преимуществах
                ...
                <ul>
                    <li><strong><h3>Гибкость <code>(Agility)</code></h3></strong>
                        ...
                        полномочиями команды, способные выбирать свой технологический стек и процесс. Таким командам не
                        нужно ждать, чтобы развернуть новую функциональность в производстве. Такая среда идеально
                        подходит
                        для внедрения <code><strong>Agile</strong></code>-практик управления <strong>it-продуктами</strong>. Кроме
                        того, она
                        значительно сокращает время
                        выхода
                        на рынок (от англ. <code>TTM</code> - Time To Market).
                    </li>
                    <br/>
                    <li><strong><h3>Инновации</h3></strong>
                        Не секрет, что процедурные и технологические изменения быстрее и
                        легче
                        вносятся в
                        небольших масштабах. Команды могут быстро проверить какую-либо гипотезу и понять, работает она
                        или нет.
                        Такие
                        небольшие эксперименты в рамках контроллируемых командой <strong>микросервисов</strong>, сильно
                        снижают риск
                        возникновения <strong>блокеров</strong> (от англ. <code>Blocker</code> - ошибка, которая
                        блокирует
                        работу критически важных бизнес-процессов) в производстве.
                    </li>
                    <br/>
                    <li><strong><h3>Качество</h3></strong> Небольшие и хорошо структурированные
                        <strong>микросервисы</strong>
                        обычно имеют <strong>меньше
                            ошибок</strong> по
                        сравнению со
                        <strong>сложными монолитными системами</strong>, в которых обычно присутствует унаследованный
                        <strong><a
                                href="https://ru.wikipedia.org/wiki/Спагетти-код#:~:text=Спагетти%2Dкод%20(также%20индусский%20код,и%20других%20конструкций%2C%20ухудшающих%20структурированность.">
                                «спагетти-код»</a></strong>.
                        Кроме
                        того, такая среда <strong>упрощает автоматизацию тестирования</strong>. В результате <strong>качество
                            существенно
                            повышается</strong>.
                    </li>
                    <br/>
                    <li><strong><h3>Масштабируемость</h3></strong> Основное преимущество заключается в том, что каждый
                        конкретный
                        <strong>микросервис может быть
                            реализован в рамках наиболее подходящей технологии и/или фреймворка</strong>: например,
                        бизнес-логика на
                        Java, критически важные модули на Erlang. По своей сути <strong>микросервисная архитектура
                            it-продукта
                            допускает
                            горизонтальное масштабирование</strong>, что позволяет масштабировать всю систему, в полной
                        мере использовать
                        преимущества <strong>Docker</strong> и <strong>облачных мощностей</strong>.
                    </li>
                    <br/>
                    <li><strong><h3>Доступность</h3></strong> <strong>Микросервисы</strong> упрощают создание
                        высокодоступных систем.
                        Хорошо
                        определенные,
                        изолированные <strong>микросервисы</strong> можно <strong>развертывать, отслеживать и
                            автоматически заменять в случае
                            отказа</strong>.
                        Кроме того, любой отказ конкретного <strong>микросервиса</strong> приведет лишь к снижению
                        производительности
                        системы, а не повлияет на весь пользовательский путь.
                    </li>
                </ul>
                <!-- ----------------------------------------------------------------------------------------------------------->
                <!-- End first paragraph-->
        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    <br/>
                    <h2>Проблемы, связанные с <strong>релизами</strong> it-продуктов на микросервисной архитектуре</h2>
                    <p class="lead">Конечно, <strong>микросервисная архитектура</strong> - это не серебряная пуля. Как
                        и все в этом мире,
                        она имеет свою долю недостатков и ограничений. В этой статье я опущу технические аспекты и
                        сосредоточусь только на проблемах, связанных с <strong>управлением релизами
                            it-продуктов на микросервисной архитектуре</strong>. С этой точки зрения
                        я хотел бы выделить следующие проблемы:</p>
                    <ul>
                        <li><strong><h3>Частые релизы</h3></strong> По своей природе архитектура микросервисов вынуждает
                            нас
                            выпускать релизы
                            чаще, чтобы обеспечить быструю и детализированную поставку нашим клиентам. Вместо одного
                            <strong>релиза</strong> монолитного решения мы будем выпускать несколько небольших <strong>релизов</strong>
                            нескольких
                            <strong>микросервисов</strong>. С точки зрения управления <strong>релизами</strong> это
                            создает <strong>накладные
                                расходы на
                                планирование, отслеживание прогресса и интеграцию</strong>. Ситуация станет еще сложнее,
                            если учесть тот
                            факт, что у каждого микросервиса свой цикл выпуска.
                        </li>
                        <li><strong><h3>Вариативный процесс разработки</h3></strong> <code>Scrum</code>,
                            <code>Kanban</code> или что-то другое? Нет
                            проблем. <strong>Микросервисная архитектура</strong> позволяет командам выбирать свой
                            собственный процесс разработки без
                            необходимости согласовывать его с другими командами. Это, безусловно, хорошо для команд
                            разработчиков, но может стать кошмаром для <strong>менеджера продукта</strong> или <strong>менеджера
                                релиза</strong> (
                            <code>PO</code>
                            /<code>RM</code>), которому
                            необходимо создать единый план для всего решения.
                        </li>
                        <li><strong><h3>Зависимости между релизами микросервисов</h3></strong>. Для реализации
                            определенной
                            бизнес-функции
                            ...
                            монолитного решения. <code>PO</code>/<code>RM</code> приходится объединять эти
                            версии в консолидированный план, чтобы
                            ответить на вопрос <strong>«Когда будет предоставлена функциональность?»</strong>, а не
                            просто знать дату
                            <strong>релиза</strong> монолита. Задержка любой версии приведет к общей задержке всего
                            процесса поставки.
                            Поэтому у <code>PM</code>/<code>RM</code> должен быть простой способ интегрировать несколько
                            <strong>версий</strong>
                            в единый пакет
                            поставки и отслеживать, был ли он поставлен в соответствии с планом.
                        </li>
                        <li><strong><h3>Интеграционное тестирование end to end</h3></strong> Этот пункт особенно
                            актуален для
                            ...
                            будет реализована в каждом конкретном <strong>микросервисе</strong>. Для этого
                            <strong>PO</strong>/<strong>RM</strong> должен иметь
                            представление о последней стабильной <strong>версии</strong> каждого
                            <strong>микросервиса</strong>, иметь представление о том,
                            какие <strong>версии</strong> развернуты и в каком <strong>окружении</strong> (<strong>пул
                                окружений</strong> или <strong>контейнеры</strong> в определенной
                            конфигурации), а также координировать тестирование и приемку.
                        </li>
                    </ul>

                    <p class="lead">В <strong>Jira</strong> есть встроенные <strong>версии</strong> и функциональность
                        отслеживания прогресса. Но,
                        принимая во внимание вышеупомянутые проблемы, существуют открытые вопросы для построения
                        эффективного релизного процесса <strong>микросервисов</strong>:</p>

                    <ul>
                        <li>Невозможно <strong>определить рабочий процесс версии</strong>, поэтому невозможно понять, на
                            какой стадии
                            находится <strong>версия</strong>. Например, все функциональные требования могут быть
                            выполнены, но <strong>версия
                                микросервиса</strong> должна пройти нагрузочное тестирование перед развертыванием в
                            <strong>производственной
                                среде</strong>.
                        </li>
                        <li>Скорее всего, различные команды, разрабатывающие <strong>микросервисы</strong>, будут
                            работать по своему собственному <strong>workflow</strong> в <strong>Jira</strong>, чтобы
                            иметь возможность гибко организовать
                            свой собственный
                            процесс разработки. Из коробки <strong>Jira</strong> не имеет удобной функциональности для
                            визуализации и
                            отслеживания версий из нескольких продуктов в одном месте.
                        </li>
                        <li>Кроме того, было бы выгодно объединить <strong>несколько версий микросервисов в один
                                релиз</strong>, который
                            будет представлять желаемую бизнес-функциональность во всех сервисах.
                        </li>
                        <li><strong>Релиз</strong> может иметь свой собственный <strong>workflow</strong>. Например,
                            перед внедрением в
                            производство может потребоваться сквозное тестирование, даже после принятия клиентом B2B.
                        </li>
                    </ul>

                    <h2>Инструменты для управления релизом</h2>
                    <p class="lead">Видно, что <strong>Jira</strong> обладает большой гибкостью и позволяет устранить
                        эти ограничения
                        различными и эффективными способами: используя встроенные возможности или расширяя их с помощью
                        сторонних приложений.</p>
                    <p class="lead">Вы можете обратиться к <a
                            href="https://www.atlassian.com/blog/jira-software/jira-release-management-steps"> этой
                    ...
                    <p class="lead">Альтернативный способ организации управления <strong>релизами микросервисов</strong>
                        ...
                        приложение <a
                            ...
                            Jira
                            Cloud).</a></p>
                    <h2>Определим контекст</h2>
                    <p class="lead">Представим себе организацию с 5 командами, которые работают над своими собственными
                        микросервисами:</p>
                    ...
                    <h2>Визуализация версий различных сервисов на доске</h2>
                    <p class="lead">Одно из правил <strong>Kanban</strong> гласит: «Визуализируйте поток». Это правило -
                        очень важная
                        концепция, поскольку большинство людей на Земле - визуалы, поэтому они лучше воспринимают
                        визуальное представление информации. В приложении <strong>Release Management</strong> можно
                        импортировать <strong>версии</strong>
                        из нескольких сервисов и визуализировать их на доске. Из коробки <strong>Jira</strong> имеет два
                        <strong>статуса версий</strong>:
                        <strong>Releases</strong> и <strong>Unreleased</strong>. Приложение <strong>Releases
                            Management</strong>
                        расширяет эту возможность за счет
                        пользовательского <strong>workflow версий</strong>. <strong>Workflow</strong> легко
                        интегрируется со встроенными
                        <strong>статусами версий</strong>.</p>

                    <figure class="sign">
                        <p><img src="/assets/img/release_2.png"
                                alt="Kanban доска в Jira для визуализации версий"></p>
                        <figcaption>Kanban доска в Jira для визуализации версий
                        </figcaption>
                    </figure>

                    <p class="lead">Особое преимущество, о котором я хотел бы рассказать, - это возможность
                        перетаскивать <strong>версии</strong> из одного столбца в другой на одной доске, так что
                        <strong>менеджеру релиза</strong> не
                        нужно перескакивать между разными страницами веб-интерфейса, чтобы обновить несколько
                        распределенных версий.</p>

                    <h2>Создание многоверсионного релиза</h2>
                    <p class="lead">Хотя хорошо, когда все версии из нескольких сервисов визуализируются на одной доске,
                        запоминать и держать в голове, какие именно версии должны быть выпущены для реализации
                        той или иной <strong>User story</strong>, не надежно и слишком рискованно.</p>

                    <p class="lead">Чтобы решить эту проблему, в приложении была введена сущность
                        <strong>Release</strong>. <strong>Release</strong> может
                        состоять из нескольких <strong>версий</strong>. При этом каждая <strong>версия</strong> может
                        не принадлежать, принадлежать одному или
                        нескольким релизам.</p>
                    <p class="lead">В нашем примере мы можем объединить все <strong>версии</strong>, которые должны быть
                        поставлены для
                        расширения китайского рынка, в один <strong>Release</strong> и отслеживать их вместе.</p>
                    ...
                    <p class="lead">Кроме того, сущность <strong>Release</strong> может иметь свой собственный <strong>workflow</strong>
                        для
                        визуализации деятельности, связанной с поставкой <strong>User story</strong>, например,
                        включающий в себя статусы: <strong>интеграционное
                    ...
                    <h2>Построение временной шкалы</h2>
                    <p class="lead"><strong>Управление релизами</strong> - это не только <strong>статусы</strong>, но и
                        точное знание того, когда будет
                        готова та или иная версия. Представление в виде <strong>Timeline</strong> - идеальное решение
                        для этой цели. Кроме
                    ...
                    <p class="lead"><strong>Непрерывная доставка</strong> (от англ. <strong>Continuous delivery</strong>)
                        ...
                        автоматически обновлять <strong>статусы версий</strong> после каждого развертывания.</p>

                    <p class="lead">Приложение <strong>Release Management</strong> имеет мощный <strong>REST
                            API</strong>, который позволяет легко
                        интегрироваться с <strong>CI-сервером</strong> с помощью <strong>webhooks</strong>. Это
                        значительно сократит объем ручной
                        работы и накладные расходы менеджеров.</p>
                    <h2>Заключение</h2>
                    <p class="lead"><strong>Микросервисная архитектура</strong> - это мощная технология разработки
                        программного
                        ...
                        что крайне важно для высококонкурентных рынков.</p>
                    <p class="lead"></p>
                    <p class="lead">Чтобы в полной мере использовать преимущества <strong>микросервисной
                            архитектуры</strong>, нам
                        необходимо снизить управленческие накладные расходы, которые естественным образом возникают в
                        гранулированной и распределенной системе (в отличие от монолита).</p>
                    <p class="lead">Приложение <strong>Release Management</strong> помогает устранить накладные расходы,
                        автоматизировать
                        рутинные операции и создать единое рабочее пространство для RM/PO. Кроме того, оно обеспечивает
                        лучшую видимость и делает управление сложными, <strong>многокомпонентными релизами</strong>
                        простым и
                        понятным.</p>
