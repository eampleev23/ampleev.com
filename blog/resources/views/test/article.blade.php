            ...
            <div class="col-xl-7 col-lg-8 col-md-10">
                <article class="article">
                    ...
                    <p class="lead"> После публикации среди друзей <a
                        ...
                        Поэтому, в этой статье я постараюсь раскрыть специфику работы в SAFe относительно Scrum. Я точно
                        не претендую на истину в первой инстанции и буду рад любым исправлениям и уточнениям со стороны
                        коллег.</p>

                    <h4>Сначала перечислю тезисно и, ниже, постараюсь раскрыть каждый тезис.</h4>
                    <ul>
                        <li>Длительность инкремента</li>
                    ...
                    <p><b>Длительность инкремента.</b> Стоит начать с того, что в SCRUM инкремент по длительности равен
                        1
                        спринту. В SAfe же, это 2,5 месяца примерно: четыре спринта как в скраме и пятый спринт
                        полностью для обучения команд.</p>

                    <p><b>Agile Release Train</b> - это совокупность команд, работающих над одним продуктом. В нашем
                        случае,
                        это правило не полностью соблюдается и под поездом понимают совокупность продуктов т.к.
                        большинство бизнес-фич реализуется комплексно и затрагивают несколько продуктов.</p>

                    <p><b>Количество взаимодействующих команд</b> в SAFe существенно больше, в сумме рекомендуется до
                        150
                        человек в одном поезде. В нашем случае это правило нарушается, у нас больше.</p>

                    <p>Примерно каждые 2,5 месяца (каждые 5 спринтов) происходит событие <b>PIPE - Programm Increment
                            Planning Event</b>. Это когад все распределенные команды собираются в одном зале на 2 дня и
                    ...
                    <p><b>SOS - Scrum Of Scrum.</b> Не уверен, что это мероприятие есть в последней версии SAFe, но у
                        нас оно
                        систематически
                        проходит (1 раз в неделю). Скрам Мастера всех команд поезда собираются в онлайне, транслируется
                        ...
                        и не для команды, а для всего поезда.</p>
                    ...
                    <p><b>PO (Product Owner)</b> - не собственник бизнеса. Есть Product Manager - он работает с
                        ...
                        команде - бъет фичи на User Stories (в нашем случае совместно с командой).</p>
                    ...
                    <p>Здесь я перечислил основные отличия, которые сам быстро вспомнил. Уверен, что здесь их основная
                        масса и для быстрого представления информации достаточно. В остальном, мы работаем по SCRUM.
                    </p>
