        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    ...
                    <p class="lead"><i>Даже если вы запустите <code>HTTP/2</code> без <strong>TLS</strong>, клиент все
                            равно может по умолчанию
                            использовать <code>HTTP/1.1</code>. Приведенное ниже решение не гарантирует, что клиенты
                            (внешние службы)
                            будут использовать <code>HTTP/2</code> с вашим <strong>HTTP</strong>-сервером.</i></p>
