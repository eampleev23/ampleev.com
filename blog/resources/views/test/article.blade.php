...
<head>
    ...
    <!-- Title ----------------------------------------------------------->
    <title>Использование собственных типов в Golang</title>
    <!-- Title ----------------------------------------------------------->
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Description ----------------------------------------------------------->
    <meta name="description"
          content="В данной статье приведены примеры правильного использования собственных типов в Golang">
    <!-- Description ----------------------------------------------------------->
                ...
                <div class="col py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex">
                            ...
                            <div class="text-small">Использование <strong>собственных типов</strong> в
                                <code>Golang</code>
                            </div>
                            <!-- Заголовок в прогресс-баре -------------------------------------------------------->
                        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-8">
                ...
                <!-- Заголовок статьи H1-->
                <h1>Использование <strong>собственных типов</strong> в
                    <code>Golang</code></h1>
                <!-- Заголовок статьи H1-->
                <!-- ----------------------------------------------------------------------------------------------------------->
                <div class="d-flex align-items-center">
        ...
        <div class="row justify-content-center position-relative">
            <div class="col-lg-10 col-xl-8">
                ...
                <figure><img src="/assets/img/gopher_custom_type_main.jpg"
                             alt="Использование собственных типов в
                                Golang"
                ...
                <p class="lead">Если вы раньше не работали с <strong>типизированными языками</strong>, вам может
                    показаться, что их
                    преимущества не очевидны. В этой статье мы расскажем как использовать <strong>собственные типы
                        в Go</strong>, чтобы
	...
	default:
		return ""
                    ...
                    <p class="lead">Хорошо, это гораздо чище (и читабельнее), но мы все еще не решили проблему того, что
                        ...
                        читаемое
                        значение.</p>
                    <h2>Собственные типы <code><strong>Go</strong></code> нам в помощь</h2>
