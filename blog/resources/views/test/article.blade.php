    ...
    <div class="container">
        <div class="row justify-content-center position-relative">
            <div class="col-lg-10 col-xl-8">
                ...
                <h2>Аннотация</h2>
                <p class="lead">Если вы раньше не работали с <strong>типизированными языками</strong>, вам может
                    показаться, что их
                    преимущества не очевидны. В этой статье мы расскажем как использовать <strong>систему
                        типов</strong>, чтобы
                    сделать ваш код более простым в использовании и более пригодным для повторного применения.</p>
                <h3>Целевая аудитория</h3>
                <p class="lead">
                    Эта статья предназначена для разработчиков, которые только начинают осваивать <code>Go</code> и не
                    имеют
                    практически никакого опыта работы с ним.
                </p>
                <!-- ----------------------------------------------------------------------------------------------------------->
                <!-- End first paragraph-->
                <!-- ----------------------------------------------------------------------------------------------------------->
...
func GenreToString(i int) string {
	...
	default:
		return ""
                    ...
                    <p class="lead">Первое, что нам нужно сделать, это написать более <strong>устойчивую</strong>
                        ...
                        функция GenreToString не должна будет меняться.</p>
                </article>
                <!-- ----------------------------------------------------------------------------------------------------------->
