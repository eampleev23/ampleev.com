        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    ...
                    <ul>
                        <li><strong>Структура</strong>: <code>HTTP/2</code> вводит псевдозаголовки, которые помогают
                            определить такие
                            вещи, как метод,
                    ...
                    <p class="lead"><b>Псевдозаголовоки? Сжатие HPACK? Что здесь происходит?»</b></p>
