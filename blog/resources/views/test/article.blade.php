    ...
    <div class="container">
        <div class="row justify-content-center position-relative">
            ...
            <div class="col-lg-10 col-xl-8">
                ...
                <br/>
                <ul>
                    <li><strong><h2>Гибкость (Agility)</h2></strong>. <strong>Микросервисы</strong> позволяют создавать
                        ...
                        подходит
                        для внедрения <strong>Agile</strong>-практик управления <strong>it-продуктами</strong>. Кроме
                        того, она
                        значительно сокращает время
                        выхода
                        на рынок (от англ. <strong>TTM</strong> - Time To Market).
                    </li>
                    <br/>
                    <li><strong>Инновации</strong>. Не секрет, что процедурные и технологические изменения быстрее и
                        легче
                        вносятся в
                        ...
                        снижают риск
                        возникновения <strong>блокеров</strong> (от англ. <strong>Blocker</strong> - ошибка, которая
                        блокирует
                        работу критически важных бизнес-процессов) в производстве.
                    </li>
                    <br/>
                    <li><strong>Качество</strong>. Небольшие и хорошо структурированные <strong>микросервисы</strong>
                        обычно имеют <strong>меньше
                            ошибок</strong> по
                        сравнению со
                        <strong>сложными монолитными системами</strong>, в которых обычно присутствует унаследованный
                        <strong>«спагетти-код»</strong> (плохо структурированный, запутанный код).
                        Кроме
                    ...
                    <br/>
                    <li><strong>Масштабируемость</strong>. Основное преимущество заключается в том, что каждый
                        конкретный
                        сервис может быть
                        реализован в рамках наиболее подходящей технологии и/или фреймворка: например, бизнес-логика на
                        Java, критически важные модули на Erlang. По своей сути архитектура микросервисов допускает
                        горизонтальное масштабирование, что позволяет масштабировать систему, в полной мере использовать
                        преимущества Docker и облака.
                    </li>
                    <br/>
                    <li><strong>Доступность</strong>. Микросервисы упрощают создание высокодоступных систем. Хорошо
                        определенные,
                        изолированные компоненты можно развертывать, отслеживать и автоматически заменять в случае
                        отказа.
                        Кроме того, любой отказ конкретного микросервиса приведет лишь к снижению производительности
            ...
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    ...
                    <p class="lead">Конечно, <strong>микросервисная архитектура</strong> - это не серебряная пуля. Как
                        ...
                        сосредоточусь только на проблемах, связанных с управлением <strong>релизами</strong> и
                        <strong>продуктами</strong>. С этой точки зрения
                        я хотел бы выделить следующие проблемы:</p>
                    <ul>
                        <li><strong>Частые релизы</strong>. По своей природе архитектура микросервисов вынуждает нас
                            выпускать релизы
                        ...
                        <li><strong>Вариативный процесс разработки</strong>. <strong>Scrum</strong>,
                            <strong>Kanban</strong> или что-то другое? Нет
                            ...
                            разработчиков, но может стать кошмаром для <strong>менеджера продукта</strong> или <strong>менеджера
                                релиза</strong> (
                            <strong>PO</strong>
                            /<strong>RM</strong>), которому
                            необходимо создать единый план для всего решения.
                        </li>
                        <li><strong>Зависимости между релизами микросервисов</strong>. Для реализации определенной
                            бизнес-функции
                            ...
                            монолитного решения. <strong>PO</strong>/<strong>RM</strong> приходится объединять эти
                            ...
                            процесса поставки.
                            Поэтому у <strong>PM/RM</strong> должен быть простой способ интегрировать несколько <strong>версий</strong>
                            в единый пакет
                            поставки и отслеживать, был ли он поставлен в соответствии с планом.
                        </li>
                        <li>Интеграционное тестирование <strong>end to end</strong>. Этот пункт особенно актуален для
