        ...
        <div class="row justify-content-center position-relative">
            <div class="col-lg-10 col-xl-8">
                ...
                <p class="lead"><strong>Go</strong> - <strong>типизированный язык</strong>, но большинство
                    ...
                    рассказывается о советах и трюках по написанию более надежного кода с использованием
                    пользовательских типов в <strong>Go</strong>.</p>
                <p class="lead"><strong>Go</strong> - <strong>типизированный язык</strong>, но многие проекты, с
                    которыми приходилось сталкиваться, не учитывают «простые» вещи, которые на самом деле важны. Сегодня
                    я расскажу немного о том, как использовать <strong>систему типов Go</strong> при определении
                    структур данных.</p>
                <h3>Целевая аудитория</h3>
                <p class="lead"> Эта статья предназначена для тех, кто работал с <strong>типизированными
                        языками</strong> и практически не имеет опыта работы с <strong>Go</strong>. </p>
                <!-- ----------------------------------------------------------------------------------------------------------->
                <!-- End first paragraph-->
                <!-- ----------------------------------------------------------------------------------------------------------->
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article"><br/>
                    <h2><strong>Стэк</strong> и <strong>Куча</strong>, которые мы знаем и любим</h2>
