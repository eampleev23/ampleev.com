            ...
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article"><br/>
                    ...
                    <p class="lead">Во многих популярных языках программирования под <strong>Стеком</strong>
                        ...
                        вызовов <strong>одного Потока (от англ. Thread)</strong>. <strong>Стек вызовов</strong> - это
                        Стековая
                        структура данных
                        ...
                        Каждый вызов функции добавляет (от англ. pushes) новую инструкцию в <strong>Стек</strong>, а
                        каждый возврат
                        функции убирает
                        (от англ. pops) инструкцию из <strong>Стека</strong>.</p>
                    <p class="lead">Мы должны иметь возможность безопасно освободить память последнего
                        <strong>Фрэйма</strong> <strong>Стека</strong>,
