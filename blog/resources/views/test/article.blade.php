                ...
                <div class="col py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex">
                            ...
                            <div class="text-small">Практика применения Cumulative Flow в контексте Scrum и SAFe</div>
                        </div>
            ...
            <div class="col-xl-7 col-lg-8 col-md-10">
                <article class="article"><p class="lead"> В этой статье я планирую рассказать как на своей практике мы
                    ...
                    <p>Наверное, многие согласятся с тем, что (особенно в России) у нас люди достаточно часто стараются
                        ...
                        новых) поменьше и получать денег побольше. С размером компании возможности для этого, кажется,
                        что растут прямо пропорционально. С этим, как правило, работают различные околоHR'ы, которые
                        всячески пытаются строить правильную систему мотивации. Сюда же OKR'ы и т.д. В целом, кажется,
                        все это нацелено на сбалансированность нагрузки каждого внутри корпорации и комфорт всех
                        заинтересованных групп лиц/команд корпорации. В данной статье я поделюсь метрикой, которую сам
                        придумал и применяю в команде. Она позволяет, как мне кажется, дополнить усилия HR'ов и OKR'ов в
                        сбалансированности нагрузки внутри одной конкретной команды или увидеть дисбаланс,
                        соответственно. Также, она вполне может и масштабироваться на команду команд, не вижу в этом
                        особой проблемы.</p>
                    <p>Таким образом, мне как Скрам Мастеру достаточно очевидно порой, что нагрузка в команде не
                        ...
                        случилась такая ситуация и я задумался о том какая метрика могла бы ярко высветить данную
                        проблему. В итоге, это вылилось в персональный рейтинг каждого члена команды. </p>
                    ...
                    <p class="lead">Метрики должны строиться на основании тех данных, которые вы и так получаете.
                        Получение какой-либо метрики не должно заставлять команду систематически тратить больше времени
                        и подстраивать свой процесс доставки ценности под саму метрику. Подробнее об этом я постараюсь
                    ...
                    <p>Итак, пример конкретного случая. Конечно, мы используем доску для передвижения User Stories по
                        статусам от DOR (Definition Of Ready) до DOD (Definition Of Done). Она у нас виртуальная (т.е.
                        расположена в интернете по ссылке. Команда у нас тоже распределенная и стендапы проходят через
                        корпоративный скайп как раз с трансляцией доски.</p>
                    <p>Члену команды удобно ставить себя в участники User Story, чтобы при использовании фильтра по себе
                        можно было быстро оставить только те истории, в которых он участвует в данный момент(чаще всего
                        этим фильтром мы пользуемся на стендапах).</p>
                    <div class="popover-image">
                    ...
                    </p>                      <p>Согласно этой сортировке мы получим текущий рейтинг членов команды в
                        следующем виде.
                    <ul>
                    ...
                    <ul>
                        <li>1 день
                            ...
                            <div class="popover-image"><img src="assets/img/member_rating_1day_graph.jpg" alt="Image"
                                                            class="rounded border shadow-lg"></div>
                        ...
                        <li>2 день
                            <div class="popover-image">
                                <div id="first_point" class="popover-hotspot bg-primary-2" style="top: 76%; left: 90%;"
                                     data-toggle="tooltip" data-placement="bottom" title=""
                                     data-original-title="Во второй день частично ушли в работу."></div>
                                <img src="assets/img/article-member_rating_day_2.jpg" alt="Image"
                                     class="rounded border shadow-lg"></div>
                            <div class="popover-image"><img src="assets/img/member_rating_2day_graph.jpg" alt="Image"
                                                            class="rounded border shadow-lg"></div>
                            <br/> 1 место: Василий (сожжено 0 из 23) динамика(1->1)<br/> 2 место: Аркадий (сожжено 0 из
                            29) динамика(2->2)<br/> 3 место: Татьяна (сожжено 0 из 32) динамика(3->3)<br/></li>
                        <li>3 день
                            <div class="popover-image">
                                <div id="first_point" class="popover-hotspot bg-primary-2" style="top: 76%; left: 90%;"
                                     data-toggle="tooltip" data-placement="bottom" title=""
                                     data-original-title="В третий день продолжается процесс."></div>
                                <img src="assets/img/article-member_rating_day_3.jpg" alt="Image"
                                     class="rounded border shadow-lg"></div>
                            <div class="popover-image"><img src="assets/img/member_rating_3day_graph.jpg" alt="Image"
                                                            class="rounded border shadow-lg"></div>
                            <br/> 1 место: Василий (сожжено 5 из 23) динамика(1->1->1)<br/> 2 место: Аркадий (сожжено 5
                            из 29) динамика(2->2->2)<br/> 3 место: Татьяна (сожжено 5 из 32) динамика(3->3->3)<br/></li>
                        <li>4 день
                            <div class="popover-image">
                                <div id="first_point" class="popover-hotspot bg-primary-2" style="top: 76%; left: 90%;"
                                     data-toggle="tooltip" data-placement="bottom" title=""
                                ...
                                <img src="assets/img/article-member_rating_day_4.jpg" alt="Image"
                                     class="rounded border shadow-lg"></div>
                            <div class="popover-image"><img src="assets/img/member_rating_4day_graph.jpg" alt="Image"
                                                            class="rounded border shadow-lg"></div>
                            <br/> 1 место: Василий (сожжено 8 из 23) динамика(1->1->1->1)<br/> 2 место: Аркадий (сожжено
                            8 из 29) динамика(2->2->2->2)<br/> 3 место: Татьяна (сожжено 9 из 32)
                        ...
                        <li>5 день
                            <div class="popover-image">
                                ...
                                <img src="assets/img/article-member_rating_day_5.jpg" alt="Image"
                                     class="rounded border shadow-lg"></div>
                            <div class="popover-image"><img src="assets/img/member_rating_5day_graph.jpg" alt="Image"
                                                            class="rounded border shadow-lg"></div>
                    ...
                    </p>                      <p>Таким образом, используя данную метрику можно накапливать персональную
                        статистику каждого члена команды и помогать ему делать правильные выводы. Например, здесь мы
                        видим, что Василий очень грамотно спланировал свое время с самого начала(т.е. на планировании
                        спринта он договорился с командой о том объеме работ, который он и выполнил по факту.) Но, в то
                        же время, может он мог как-то помочь другим членам команды? Возможно и нет, но стоит подумать
                        над этим вопросом перед ретроспективой.</p>
                    <p>У Татьяны и Аркадия проблема посерьезнее. Очевидно, что с самого начала на планировании спринта
                        они договорилась с командой об участии во всех историях и по факту не смогли выполнить
                        обязательства. О причинах также стоит подумать перед ретроспективой. Возможно стоит меньше
                        планировать на себя, возможно расширять компетенции чтобы успевать все запланированное, возможны
                        и другие решения. </p>
                    ...
                    <p>В заключении, хотелось бы обратить особое внимание на тот факт, что перед использованием этой
                        метрики в команде должен быть уже достаточно высокий уровень доверия у большей части команды.
                        Также, я рекомендовал бы делать большой акцент на том, что первично - отсутствие переработок и
                        комфортная деятельность.</p>
                    <p class="lead">Мы акцентируемся на правильном прогнозировании результата, а не на мотивации
                        ...
                        способности планирования каждого члена команды в отдельности.</p>
                </article>
            </div>
        </div>
    </div>
