        ...
        <div class="row justify-content-center position-relative">
            ...
            <div class="col-lg-10 col-xl-8">
                ...
                <p class="lead"><code>iota</code> - полезная концепция для создания инкрементных констант в
                    ...
                    областей, в которых использование этой функциональности языка может быть неуместным. В этой статье
                    мы
                    рассмотрим несколько
                    различных способов применения <code>iota</code>, а также дадим рекомендации о корректности ее
                    использования.</p>
            </div>
            <!-- ----------------------------------------------------------------------------------------------------------->
            <!-- End first paragraph-->
