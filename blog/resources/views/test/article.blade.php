            ...
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    ...
                    <p class="lead">
                        ...
                        нечто начинается с очень специфической последовательности из 24 байт: <br/><code>PRI *
                            HTTP/2.0\r\n\r\n\nSM\r\n\r\n</code><br/>
                        Эта последовательность подтверждает, что используется протокол HTTP/2. На этом этапе еще нет ни
                        сжатия, ни кадрирования.
                    </p>
                    <br/>
