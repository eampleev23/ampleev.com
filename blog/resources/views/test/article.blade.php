        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <article class="article">
                    ...
                    <h4>А как насчет сжатия <b>HPACK</b>?</h4>
                    ...
                    <h4>Так что же происходит со случайным значением?</h4>
                    ...
                    <h4>Но как быть с порядком <strong>Фрэймов</strong> в <strong>Потоке</strong>? Что, если они
                        поступают не по
                        порядку?</h4>
                    <p class="lead">Да, хотя <strong>Идентификатор Потока</strong> говорит нам, к какому
                        <strong>Потоку</strong> принадлежит <strong>Фрэйм</strong>, он не
                        определяет порядок <strong>Фрэймов</strong>.</p>
