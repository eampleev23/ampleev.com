                                ...
                                <div class="col-auto" data-dropdown-content>
                                    <div class="dropdown-grid-menu"><a href="about-company.html"
                                                ...
                                                <div class="col-auto" data-dropdown-content>
                                                    <div class="dropdown-grid-menu"><a href="pricing-plans.html"
                                                            ...
                                                            Plans</a><a href="pricing-plans-table.html"
                                                                        class="dropdown-item fade-page">Pricing Plans
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu row">
                                                <div class="col-auto" data-dropdown-content>
                                                    <div class="dropdown-grid-menu"><a href="account-onboarding.html"
                                ...
                                <div class="col-auto" data-dropdown-content>
                                    <div class="dropdown-grid-menu">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu row">
                                                <div class="col-auto" data-dropdown-content>
                                                    <div class="dropdown-grid-menu"><a href="portfolio-2-columns.html"
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu row">
                                                <div class="col-auto" data-dropdown-content>
                                                    <div class="dropdown-grid-menu"><a href="portfolio-case-study.html"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg col-md-4 mb-3 mb-lg-0">
                                            ...
                                            <div><a class="dropdown-item fade-page"
                                                    href="elements-alerts.html">Alerts</a><a
                                                        class="dropdown-item fade-page" href="elements-avatars.html">Avatars</a><a
                                                        class="dropdown-item fade-page" href="elements-badges.html">Badges</a><a
                                                        class="dropdown-item fade-page"
                                                        href="elements-breadcrumbs.html">Breadcrumbs</a><a
                                                        class="dropdown-item fade-page" href="elements-buttons.html">Buttons</a><a
                                                        class="dropdown-item fade-page"
                                                        ...
                                                        class="dropdown-item fade-page" href="elements-footers.html">Footers</a>
                                                <a
                                                        class="dropdown-item fade-page" href="elements-navbars.html">Navigation</a><a
                                                        class="dropdown-item fade-page" href="elements-tooltips.html">Tooltips</a><a
                                                        class="dropdown-item fade-page" href="elements-toasts.html">Toasts</a><a
                                                        class="dropdown-item fade-page" href="elements-widgets.html">Widgets</a>
                                            </div>
                                        </div>
                                        <div class="col-lg col-md-4 mb-3 mb-lg-0">
                                            <h5>Graphic</h5>
                                            <div><a class="dropdown-item fade-page" href="elements-decorations.html">Decorations</a><a
                                                        class="dropdown-item fade-page" href="elements-dividers.html">Dividers</a><a
                                                        class="dropdown-item fade-page"
                                                        href="elements-icons.html">Icons</a>
                                                <a
                                                        class="dropdown-item fade-page"
                                                        href="elements-icons-reference.html">Icons Reference</a><a
                                                        class="dropdown-item fade-page" href="elements-processes.html">Processes</a><a
                                                        class="dropdown-item fade-page" href="elements-progress.html">Progress</a><a
                                                        class="dropdown-item fade-page" href="elements-pricing.html">Pricing</a>
                                            </div>
                                        </div>
                                        <div class="col-lg col-md-4 mb-3 mb-lg-0">
                                            <h5>Media</h5>
                                            <div><a class="dropdown-item fade-page" href="elements-fancybox.html">Fancybox</a><a
                                                        class="dropdown-item fade-page" href="elements-isotope.html">Isotope</a><a
                                                        class="dropdown-item fade-page"
                                                        href="elements-maps.html">Maps</a><a
                                                        class="dropdown-item fade-page"
                                                        href="elements-flickity.html">Slider Flickity</a><a
                                                        class="dropdown-item fade-page" href="elements-twitter.html">Twitter
                                        ...
                                        <div class="col-lg col-md-4 mb-3 mb-lg-0">
                                            ...
                                            <div><a class="dropdown-item fade-page" href="elements-animations.html">Animations</a><a
                                                        class="dropdown-item fade-page" href="elements-accordions.html">Accordion</a><a
                                                        class="dropdown-item fade-page" href="elements-counters.html">Counters</a>
                                                <a
                                                        class="dropdown-item fade-page" href="elements-countdown.html">Countdown</a><a
                                                        class="dropdown-item fade-page"
                                                    ...
                                                    (Nav)</a>
                                                <a
                                                        class="dropdown-item fade-page" href="elements-typed-text.html">Typed
                                                    Text</a><a class="dropdown-item fade-page"
                                                               href="elements-parallax.html">Parallax</a><a
                                                        class="dropdown-item fade-page" href="elements-popovers.html">Popovers</a><a
                                                        class="dropdown-item fade-page" href="elements-wizards.html">Wizards</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="container py-0 layer-2">
        ...
        <div class="row my-4 my-md-6 text-light" data-aos="fade-up">
            <div class="col-lg-9 col-xl-6">
                ...
                <p class="lead mb-0">Bootstrap’s JavaScript modal plugin to add dialogs to your site for lightboxes,
                    user notifications, or completely custom content.</p>
            </div>
        </div>
        <div class="alert alert-primary mb-5">
            <div class="d-flex">
                <img class="icon bg-primary" src="assets/img/icons/theme/files/selected-file.svg"
                     alt="selected-file icon" data-inject-svg/>
                <div class="ml-2 flex-grow-1">
                    This page demonstrates Modals functionality, <a target="_blank"
                                                                    href="http://getbootstrap.com/docs/4.3/components/modal/">See
                        Bootstrap Documentation</a> for a detailed technical explanation.
                </div>
            </div>
        </div>
    </div>
    <div class="decoration right middle-y scale-4">
        <img class="bg-primary" src="assets/img/decorations/deco-blob-3.svg" alt="deco-blob-3 decoration"
             data-inject-svg/>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex flex-wrap">
                ...
                <div class="m-1">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#sign-up-modal">
                        Sign Up
                    </button>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="m-xl-4 m-3">
                                        <div class="text-center mb-4">
                                            <h4 class="h3 mb-1">Create Account</h4>
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group">
                                                <input type="password" name="signup-password-confirm"
                                    ...
                                    <div class="m-xl-4 m-3">
                                        <div class="icon-round icon-round-lg bg-primary mx-auto mb-4">
                                            <img class="icon bg-primary"
                                                 src="assets/img/icons/theme/communication/mail-opened.svg"
                                                 alt="mail-opened icon" data-inject-svg/>
                                        </div>
                                        <div class="text-center mb-4">
                                            <h4 class="h3 mb-1">Subscribe</h4>
                                            <p>Subscribe and receive our newsletters to follow the news about our fresh
                                                and fantastic products.</p>
                                        </div>
                                        ...
                                        <small class="text-muted form-text">We’ll never share your details. See our <a
                ...
                <div class="m-1">
                    <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#subscribe-image-modal">
                        Subscribe Image
                    </button>
                    <div class="modal fade" id="subscribe-image-modal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content bg-primary text-light border-0">
                                <img src="assets/img/inner-6.jpg" alt="Image"
                                     class="bg-image blend-mode-multiply rounded opacity-50">
                                <div class="modal-body">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <img class="icon bg-white" src="assets/img/icons/interface/cross.svg"
                                             alt="cross interface icon" data-inject-svg/>
                                    </button>
                                    <div class="m-xl-6 m-3 text-center">
                                        <div class="mb-4">
                                            <h4 class="display-4">Stay in the loop</h4>
                                            <p class="lead">Subscribe and receive our newsletters to follow the news
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <div class="m-xl-4 m-3">
                                        <div class="icon-round icon-round-lg bg-primary mx-auto mb-4">
                                            <img class="icon bg-primary"
                                                 src="assets/img/icons/theme/communication/readed-mail.svg"
                                                 alt="readed-mail icon" data-inject-svg/>
                                        </div>
                                        <div class="text-center mb-4">
                                            <h4 class="h3">Check Your Inbox</h4>
                                            <p>We have just sent further instructions for activating your account to
                                                <strong>name@company.io</strong>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="m-1">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#promo-modal">
                        Promo
                    </button>
                    <div class="modal fade" id="promo-modal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content bg-primary-3 text-light border-0">
                                <img src="assets/img/inner-10.jpg" alt="Image" class="bg-image rounded opacity-50">
                                <div class="modal-body">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <img class="icon bg-white" src="assets/img/icons/interface/cross.svg"
                                             alt="cross interface icon" data-inject-svg/>
                                    ...
                                    <div class="m-xl-6 m-3 text-center">
                                        <div class="mb-4">
                                            <span>Enter your email and get</span>
                                            <h4 class="display-4 mt-3">Get 30% off your first purchase.</h4>
                                        </div>
                                        <form data-form-email action="/forms/mailchimp.php" novalidate>
                                            <div class="d-md-flex mb-3 justify-content-center">
                                                <input type="email" name="email"
                                                       class="mx-1 form-control form-control-lg mb-2 mb-md-0"
                                                       placeholder="Email Address" required>
                                                <button type="submit" class="mx-1 btn btn-primary btn-lg btn-loading"
                                                        data-loading-text="Sending">
                                                    <img class="icon" src="assets/img/icons/theme/code/loading.svg"
                                                         alt="loading icon" data-inject-svg/>
                                                    <span>Redeem</span>
                                            ...
                                            <div>
                                                <div class="d-none alert alert-success" role="alert"
                                                     data-success-message>
                                                    Thanks, please check your inbox for your promo code.
                                                </div>
                                                <div class="d-none alert alert-danger" role="alert" data-error-message>
                                                    Please fill all fields correctly.
                                                </div>
                ...
                <div class="m-1">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cookies-modal">
                        Cookies
                    </button>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="d-flex m-2 align-items-center">
                                        <img src="assets/img/flags/eu.svg" alt="EU Flag" class="icon icon-lg">
                                        <div class="mx-3">
                                            Our site uses cookies to ensure the best browsing experience possible. See
                                            our <a href="#">Privacy Policy</a> for more details.
                                        </div>
                                        <button class="btn btn-primary" data-dismiss="modal">Agree &amp; continue
                                        </button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="m-1">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#contact-box-modal">
                        Contact Box
                    </button>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="m-3">
                                        <ul class="avatars justify-content-center">
                                            <li>
                                                <img src="assets/img/avatars/male-1.jpg" alt="Avatar"
                                                     class="avatar avatar-lg">
                                            </li>
                                            <li>
                                                <img src="assets/img/avatars/female-1.jpg" alt="Avatar"
                                                     class="avatar avatar-lg">
                                            </li>
                                            <li>
                                                <img src="assets/img/avatars/male-2.jpg" alt="Avatar"
                                                     class="avatar avatar-lg">
                                            </li>
                                            <li>
                                                <img src="assets/img/avatars/female-4.jpg" alt="Avatar"
                                                     class="avatar avatar-lg">
                                            </li>
                                        </ul>
                                        <div class="text-center my-3">
                                            <h4 class="h3 mb-1">Contact Support</h4>
                                            <p>
                                                Please get in touch for any questions you may have. We typically reply
                                                within 24 hours.
                                            </p>
                                        </div>
                                        <form action="/forms/smtp.php" data-form-email novalidate>
                                            ...
                                            <div class="form-group">
                                                <textarea name="contact-box-message" rows="5" class="form-control"
                                                          placeholder="Type your message here" required></textarea>
                                            </div>
                                            <div data-recaptcha
                                                 data-sitekey="INSERT_YOUR_RECAPTCHA_V2_SITEKEY_HERE"></div>
                                            <div class="d-none alert alert-danger" role="alert" data-error-message>
                                                Please fill all fields correctly.
                                            </div>
                                            ...
                                            <button type="submit" class="btn btn-block btn-primary btn-loading"
                                                    data-loading-text="Sending">
                                                <img class="icon" src="assets/img/icons/theme/code/loading.svg"
                                                     alt="loading icon" data-inject-svg/>
                                                <span>Send</span>
                ...
                <div class="m-1">
                    <button type="button" class="btn btn-primary" data-toggle="modal"
                            data-target="#contact-confirmation-modal">
                        Contact Confirmation
                    </button>
                    <div class="modal fade" id="contact-confirmation-modal" tabindex="-1" role="dialog"
                         aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="m-3 d-flex align-items-center">
                                        <img src="assets/img/avatars/female-1.jpg" alt="Avatar"
                                             class="avatar avatar-lg">
                                        <div class="ml-3">
                                            <h5 class="mb-1">Message recieved!</h5>
                                            <span>Thank you for your enquiry. We'll respond as quick as we can.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="m-1">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#download-app-modal">
                        Download App
                    </button>
                    <div class="modal fade" id="download-app-modal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    ...
                                    <div class="d-flex m-2 align-items-center">
                                        <a href="#" class="flex-shrink-0">
                                            <img src="assets/img/app-icon.svg" alt="Icon" class="rounded">
                                        </a>
                                        <div class="mx-3">
                                            <h5 class="mb-1">Leap iOS App</h5>
                                            <span>For the complete experience, download the Leap iOS app</span>
                                        </div>
                                        <a href="#" class="btn btn-primary">
                                            <img class="icon" src="assets/img/icons/social/apple.svg"
                                                 alt="apple social icon" data-inject-svg/>
                                            <span>Download</span>
                                        </a>
                                    </div>
                                </div>
                ...
                <div class="m-1">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#achievement-modal">
                        Achievement
                    </button>
                    <div class="modal fade" id="achievement-modal" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content bg-primary border-0 text-light">
                                <div class="modal-body">
                                    ...
                                    <div class="m-xl-4 m-3">
                                        <div class="icon-round icon-round-lg bg-white mx-auto mb-4">
                                            <img class="icon bg-white" src="assets/img/icons/theme/general/star.svg"
                                                 alt="star icon" data-inject-svg/>
                                        </div>
                                        <div class="text-center mb-4">
                                            <h4 class="h3">Level 2 Unlocked!</h4>
                                            <div class="progress bg-primary-alt my-3">
                                                <div class="progress-bar bg-primary-3" role="progressbar"
                                                     style="width: 25%" aria-valuenow="25" aria-valuemin="0"
                                                     aria-valuemax="100"></div>
                                            </div>
                                            <p>You're on your way to becoming an elite contributor. Keep up the great
                                                work!</p>
                                            <a href="#" class="btn btn-white" data-dismiss="modal">Continue</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col col-md-auto text-center">
                <small class="text-muted">&copy;2019 This page is protected by reCAPTCHA and is subject to the Google <a
