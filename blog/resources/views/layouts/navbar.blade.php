...
{{--                <img class="icon navbar-toggler-open" src="" alt="menu interface icon" data-inject-svg="">--}}
{{--                <img class="icon navbar-toggler-close" src="" alt="cross interface icon" data-inject-svg="">--}}
{{--            </button>--}}
...
{{--                            <div class="dropdown-menu row" style="left: -700px;">--}}
{{--                                <div class="col-auto" data-dropdown-content="" style="left: 700px;">--}}
...
{{--                                                <span>Careers</span>--}}
{{--                                                <img class="icon bg-dark opacity-20" src="" alt="arrow-caret interface icon" data-inject-svg="">--}}
{{--                                            </a>--}}
...
{{--                            <div class="dropdown-menu row" style="left: -772px;">--}}
{{--                                <div class="col-auto" data-dropdown-content="" style="left: 772px;">--}}
...
{{--                            <div class="dropdown-menu row" style="left: -830px;">--}}
{{--                                <div class="col-auto" data-dropdown-content="" style="left: 830px;">--}}
{{--                                    <div class="dropdown-grid-menu">--}}
{{--                                        <div class="dropdown">--}}
{{--                                            <a href="#" class="dropdown-item dropdown-toggle" data-toggle="dropdown-grid" aria-expanded="false" aria-haspopup="true">--}}
...
{{--                            <div class="dropdown-menu bg-primary-3 text-light border-bottom" style="left: -921px;">--}}
{{--                                <div class="container py-4" data-dropdown-content="" style="left: 921px;">--}}
{{--                                    <div class="row">--}}
...
{{--                            <div class="dropdown-menu row" style="left: -1017px;">--}}
{{--                                <div class="col-auto px-0" data-dropdown-content="" style="left: 1017px;">--}}
...
{{--                                                <img class="icon icon-md" src="" alt="selected-file icon" data-inject-svg="">--}}
...
{{--                                                <img class="icon icon-md" src="" alt="chat-4 icon" data-inject-svg="">--}}
{{--                                                <div class="text-body ml-3">--}}
...
<div class="navbar-container ">
    <nav class="navbar navbar-expand-lg navbar-dark" data-overlay data-sticky="top">
        <div class="container">
            ...
            @endphp
            <a class="navbar-brand fade-page" href="{{ $site_locale === 'en' ? route('en.static_pages.home') : route('static_pages.home') }}">
                <span>Ampleev.com</span>
            </a>
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target=".navbar-collapse"
                    aria-expanded="false" aria-label="Toggle navigation">
                <img class="icon navbar-toggler-open" src="{{ asset('assets/img/icons/interface/menu.svg') }}"
                     alt="menu interface icon" data-inject-svg/>
                <img class="icon navbar-toggler-close" src="{{ asset('assets/img/icons/interface/cross.svg') }}"
                ...
                <div class="m-1 ml-lg-4 pl-lg-2 d-flex align-items-center">
                    <div class="mr-3 d-flex align-items-center text-uppercase small locale-switch">
                        <a href="{{ $locale_switch_urls['ru'] }}"
                           class="nav-link px-1 text-white locale-switch-link {{ $site_locale === 'ru' ? 'font-weight-bold' : 'opacity-50' }}"
                           rel="alternate"
                           hreflang="ru">{{ $ruSwitchLabel }}</a>
                        <span class="text-white-50 locale-switch-separator">|</span>
                        <a href="{{ $locale_switch_urls['en'] }}"
                           class="nav-link px-1 text-white locale-switch-link {{ $site_locale === 'en' ? 'font-weight-bold' : 'opacity-50' }}"
                           rel="alternate"
