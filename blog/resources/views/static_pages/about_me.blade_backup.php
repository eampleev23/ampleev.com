                ...
                <div class="col-md-7 col-xl-6">
                    <div class="row justify-content-center">
                        <div class="col-xl-8 col-lg-10">
                            ...
                            <p class="lead">Стратегический лидер с 19-летним опытом в IT направлениях разработки в
                                крупных компаниях.
                            ...
                            <p class="lead">В свободное время играю в футбол (в прошлом профессионально),
                                занимаюсь разработкой собственных продуктов fullstack (Go, Swift).</p>
                        ...
                        <li data-aos="fade-left" class="aos-init aos-animate">
                            ...
                            <div>
                                ...
                                <h5 class="mb-0">Закончил обучение в Яндекс Практикум по специализации
                                    <a href="/assets/pdf/ampleev_em_cert_advanced_golang_20242GP00104.pdf">Продвинутый Golang
