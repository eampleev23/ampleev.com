@php
    ...
    $copy = $currentLocale === 'en'
        ...
        : [
            ...
            'badge' => 'Коротко',
            'heading' => 'Обо мне',
            'lead_1' => '<code><b>IT</b></code>-менеджер с опытом в <code><b>FinTech</b></code>, крупном цифровом бизнесе и стартапах. Работаю с фокусом на ключевые бизнес-метрики: <code><b>Retention</b></code>, <code><b>LTV</b></code>, <code><b>P&L</b></code>, <code><b>TTM</b></code>. Имею опыт в управлении командами, запуске и развитии it-продуктов (<code><b>CRM</b></code>, <code><b>мобильные приложения</b></code>), системной работе над процессами (<code><b>Agile</b></code>-трансформации, разработка методологий).',
