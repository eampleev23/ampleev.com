                ...
                <div class="col-md-7 col-xl-6">
                    <div class="row justify-content-center">
                        <div class="col-xl-8 col-lg-10">
                            ...
                            <p class="lead"><b>IT-лидер / Руководитель высшего звена</b> с 19-летним опытом в FinTech,
                                E-commerce и крупном
                                цифровом бизнесе. Строю и трансформирую инженерные организации, соединяя глубокую
                                продуктовую экспертизу (управление командами, запуск CRM, мобильных приложений) с
                            ...
                            <p class="lead">Моя ценность — в способности не только внедрять практики (Scrum, SAFe,
                                архитектурные комитеты), но и создавать их «с нуля» под задачи бизнеса, переводя
                                операционные улучшения в измеримый рост ключевых метрик (Retention, LTV, скорость
                                релизов +15-40%).</p>

                            <p class="lead">Сохраняю техническую экспертизу (Go, Swift, React, ИИ-инструменты), что
                                позволяет эффективно коммуницировать с командами, принимать обоснованные архитектурные
                                решения и лично вести R&D-проекты.</p>

                            <p class="lead">Лидерские качества, отточенные в профессиональном
                                спорте, применяю для создания сплоченных и результативных команд.</p>
