<section class="has-divider bg-primary-alt">
    <div class="container">
        <div class="row justify-content-around align-items-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-8 col-md">
                        <div class="mobile-screenshot rotate-left layer-2">
                            <img src="/assets/img/IMG_3729.PNG" alt="Screenshot">
            ...
            <div class="col-lg-6 col-md-8 d-flex flex-column">
                <div class="mb-3">
                    <span class="badge badge-primary">Новое в версии 1.4</span>
                    <h3 class="h1 mt-3">
                        Присоединяйтесь по QR-коду.
                    </h3>
                    <p class="lead">
                        Теперь не нужно долго искать ссылку для присоединения. Покажите другу QR-код и он мгновенно
                ...
                <div class="row">
                    <div class="col-6">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             ...
                             class="injected-svg icon icon-md bg-primary"
                             data-src="/assets/img/icons/theme/communication/add-user.svg">
                        ...
                        <div class="mt-2">
                            <h5>И отсутствие приложения - теперь не проблема</h5>
                        </div>
                        <p>
                            Организатор теперь может добавлять участников самостоятельно, если они не могут использовать
                            приложение по какой-либо причине
                        </p>
                    </div>
                    <div class="col-6">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                             height="24px" viewBox="0 0 24 24" version="1.1"
                             class="injected-svg icon icon-md bg-primary"
                             data-src="/assets/img/icons/theme/communication/delete-user.svg">
                        ...
                        <div class="mt-2">
                            <h5>И теперь можно удалять не пришедших друзей</h5>
                        </div>
                        <p>
                            Теперь они не забивают экран информацией о себе :)
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div class="divider flip-x">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="96px"
             viewBox="0 0 100 100" version="1.1" preserveAspectRatio="none" class="injected-svg bg-primary-3"
