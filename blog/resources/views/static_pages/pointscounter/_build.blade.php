    ...
    <div class="container">
        <div class="row justify-content-center text-center mb-6">
            <div class="col-xl-8 col-lg-9">
                ...
                <br>
                <br>
                <h2 class="display-4 mx-xl-6">Подсчет очков и результатов нажатием одной кнопки</h2>
                <p class="lead">
                    Вы, как организатор, можете запланировать игру, поделиться с друзьями ссылкой для присоединения.
                    Все участники могут следить за очками в процессе игры, осуществлять пополнения (каждый на своем телефоне
                    или через организатора), завершать игру, просматривать итоги.
                </p>
            </div>
        </div>
...
{{--                             data-src="/assets/img/icons/theme/media/play.svg">--}}
...
{{--                        </svg>--}}
{{--                    </a>--}}
{{--                    <img src="/assets/img/article-5.jpg" alt="Image">--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
    </div>
