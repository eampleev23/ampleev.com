<!-- Stored in resources/views/utility/unsubscribed_comment_notifications.blade.php -->

@extends('layouts.app')

@section('title', 'Отписка от уведомлений о комментариях')
        ...
        <div class="container">
            ...
            <div class="row text-center py-6">
                <div class="col">
                    ...
                    <h2 class="h1">Вы успешно отписались от уведомлений о комментариях</h2>
                    <div class="lead mb-4">Почта {{$user->email}} больше не будет получать уведомления о новых комментариях к вашим статьям и ответах на ваши комментарии.
                    </div>
