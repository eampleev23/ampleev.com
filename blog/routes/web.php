...
Route::group([
    ...
    function () {
        Route::get('/', function () {
            ...
            return redirect('/article_daily_scrum_i_ai_pochemu_stendap_ne_dolzhen_stat_status_botom');
...
Route::group([
    ...
    function () {
        Route::redirect('/', '/en/article_daily_scrum_and_ai_why_the_standup_should_not_become_a_status_bot')->name('home');
